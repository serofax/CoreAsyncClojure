...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_20714 = 0;while(true){
var m_20715 = cljs.core.async.impl.dispatch.tasks.pop();if((m_20715 == null))
{} else
{m_20715.call(null);
if((count_20714 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__20716 = (count_20714 + 1);
count_20714 = G__20716;
continue;
}
} else
{}
