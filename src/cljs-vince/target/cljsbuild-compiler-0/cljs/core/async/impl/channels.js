...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t20720 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t20720 = (function (val,box,meta20721){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t20720.cljs$lang$type = true;
cljs.core.async.impl.channels.t20720.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t20720";
cljs.core.async.impl.channels.t20720.cljs$lang$ctorPrWriter = (function (this__3670__auto__,writer__3671__auto__,opt__3672__auto__){return cljs.core._write.call(null,writer__3671__auto__,"cljs.core.async.impl.channels/t20720");
});
cljs.core.async.impl.channels.t20720.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t20720.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20722){var self__ = this;
var _20722__$1 = this;return self__.meta20721;
});
cljs.core.async.impl.channels.t20720.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20722,meta20721__$1){var self__ = this;
var _20722__$1 = this;return (new cljs.core.async.impl.channels.t20720(self__.val,self__.box,meta20721__$1));
});
cljs.core.async.impl.channels.__GT_t20720 = (function __GT_t20720(val__$1,box__$1,meta20721){return (new cljs.core.async.impl.channels.t20720(val__$1,box__$1,meta20721));
});
}
return (new cljs.core.async.impl.channels.t20720(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_20723 = self__.takes.pop();if((taker_20723 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_20723))
{var take_cb_20724 = cljs.core.async.impl.protocols.commit.call(null,taker_20723);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_20724,taker_20723){
return (function (){return take_cb_20724.call(null,null);
});})(take_cb_20724,taker_20723))
);
} else
{}
{
