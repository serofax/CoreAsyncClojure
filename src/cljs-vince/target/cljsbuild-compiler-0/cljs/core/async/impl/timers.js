...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_20691 = 0;while(true){
if((i_20691 < arr.length))
{(arr[i_20691] = null);
{
var G__20692 = (i_20691 + 1);
i_20691 = G__20692;
continue;
}
} else
...
{var i_20698 = (self__.level + 1);while(true){
if((i_20698 <= (new_level + 1)))
{(update[i_20698] = self__.header);
{
var G__20699 = (i_20698 + 1);
i_20698 = G__20699;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_20700 = 0;while(true){
if((i_20700 <= self__.level))
{var links_20701 = (update[i_20700]).forward;if(((links_20701[i_20700]) === x__$1))
{(links_20701[i_20700] = (x__$1.forward[i_20700]));
{
var G__20702 = (i_20700 + 1);
i_20700 = G__20702;
continue;
}
} else
{{
var G__20703 = (i_20700 + 1);
i_20700 = G__20703;
continue;
}
}
