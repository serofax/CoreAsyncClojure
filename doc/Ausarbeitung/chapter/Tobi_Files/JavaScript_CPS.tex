...
Führt man das Code Beispiel \ref{sec:jscps} in einem JavaScript Interpreter aus, so lässt sich kein asynchrones Verhalten der Anwendung, wie Eingangs beschrieben, erkennen. 
\acresetall
